...
<div class="search">
    <form class="navbar-form" method="post" name="form1">
            ...
            <input class="form-control" type="text" name="search" placeholder="search a book..." required="">
...
<div class="search">
    <form class="navbar-form" method="post" name="form1">
            ...
            <button style="background-color: #ffb12a;" type="submit" name="submit1" class="btn btn-default">
            Request
            </button>
    </form>
</div>
        ...
        if(isset($_POST['submit']))
        		{
        			...
        			{
        				echo "<b>Sorry, your book is not found. Please try again!</b>";
        			}
        		else
        		{
