...
<head>
    ...
    <meta charset="UTF-8">
    <title>Guess Registration</title>
...
<section>
    ...
    <?php
          ...
          {
            $count=0;
            $sql="SELECT username from `guess`";
            ...
            if($count==0)
            {
              mysqli_query($db,"INSERT INTO `GUESS` VALUES('','$_POST[first]', '$_POST[last]', '$_POST[username]',
              '$_POST[password]', '$_POST[roll]', '$_POST[email]', '$_POST[contact]', 'avatarfemale.png');");
            ?>
